...
public class Exercise {
    ...
    public void generateExerciseOfAdditionEquations(int count) {
        generateExercise(addition, count);
    }

    public void generateExerciseOfSubtractionEquations(int count) {
        generateExercise(subtract, count);
    }

    public void generateExerciseOfEquations(int count) {
