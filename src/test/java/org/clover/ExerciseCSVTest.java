...
import org.clover.gui.ExerciseAnswer;
...
public class ExerciseCSVTest {
    ...
    private static List<Equation> getEquations(File testFile) throws IOException {
        ...
        return csv.readNoisyExerciseFromFile("test_exercises.csv");
    }

    @NotNull
    private static ExerciseAnswer getExerciseAnswer(List<Equation> equations) {
